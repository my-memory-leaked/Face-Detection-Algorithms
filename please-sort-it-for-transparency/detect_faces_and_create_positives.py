...
def detect_faces_and_save(base_dir, output_file, classifier_path):
    """
    Detect faces in images and save bounding box information to a file.

    :param base_dir: Base directory containing images in subdirectories.
    :param output_file: Output file to save the list of images with bounding boxes.
...
if __name__ == "__main__":
    ...
    detect_faces_and_save('dataset/Original-Images', 'dataset/positives.txt', 'haar-cascade-project/haar-cascade/opencv/haarcascade_frontalface_default.xml')
